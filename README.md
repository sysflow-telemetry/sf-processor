...
-	[`0.5.0-rc1`, `latest`](https://github.com/sysflow-telemetry/sf-processor/blob/0.5.0-rc1/Dockerfile), [`edge`](https://github.com/sysflow-telemetry/sf-processor/blob/master/Dockerfile), [`dev`](https://github.com/sysflow-telemetry/sf-processor/blob/dev/Dockerfile)
...
-	**Binary packages**:
	[deb](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.5.0-rc1/sfprocessor-0.5.0-rc1-x86_64.deb) | [rpm](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.5.0-rc1/sfprocessor-0.5.0-rc1-x86_64.rpm) | [tgz](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.5.0-rc1/sfprocessor-0.5.0-rc1-x86_64.tar.gz)
