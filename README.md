...
-	[`0.4.4`, `latest`](https://github.com/sysflow-telemetry/sf-processor/blob/0.4.4/Dockerfile), [`edge`](https://github.com/sysflow-telemetry/sf-processor/blob/master/Dockerfile), [`dev`](https://github.com/sysflow-telemetry/sf-processor/blob/dev/Dockerfile)
...
-	**Binary packages**:
	[deb](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.4.4/sfprocessor-0.4.4-x86_64.deb) | [rpm](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.4.4/sfprocessor-0.4.4-x86_64.rpm) | [tgz](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.4.4/sfprocessor-0.4.4-x86_64.tar.gz)
