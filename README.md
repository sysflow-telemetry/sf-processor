...
-	[`0.7.0-rc1`, `latest`](https://github.com/sysflow-telemetry/sf-processor/blob/0.7.0-rc1/Dockerfile), [`edge`](https://github.com/sysflow-telemetry/sf-processor/blob/master/Dockerfile), [`dev`](https://github.com/sysflow-telemetry/sf-processor/blob/dev/Dockerfile)
