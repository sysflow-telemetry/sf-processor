...
-	[`0.2.1`](https://github.com/sysflow-telemetry/sf-processor/blob/0.2.1/Dockerfile), [`latest`](https://github.com/sysflow-telemetry/sf-processor/blob/master/Dockerfile)
