...
-	[`0.7.0-rc2`, `latest`](https://github.com/sysflow-telemetry/sf-processor/blob/0.7.0-rc2/Dockerfile), [`edge`](https://github.com/sysflow-telemetry/sf-processor/blob/master/Dockerfile), [`dev`](https://github.com/sysflow-telemetry/sf-processor/blob/dev/Dockerfile)
...
-	**Binary packages**:
	[deb](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.7.0-rc2/sfprocessor-0.7.0-rc2-x86_64.deb) | [rpm](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.7.0-rc2/sfprocessor-0.7.0-rc2-x86_64.rpm) | [tgz](https://github.com/sysflow-telemetry/sf-processor/releases/tag/0.7.0-rc2/sfprocessor-0.7.0-rc2-x86_64.tar.gz)
